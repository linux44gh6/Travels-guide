...
const Error = () => {
	...
	<div className="container flex flex-col items-center justify-center px-5 mx-auto my-8 space-y-8 text-center sm:max-w-md">
		...
		<Link to='/' rel="noopener noreferrer" className="px-8 py-3 font-semibold rounded dark:bg-violet-600 dark:text-gray-50 bg-color-1 text-white">Back to homepage</Link>
	</div>
</section>
        </div>
    );
